            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="deptStuName" class="col-sm-2 control-label">部门名称:</label>
                        <div class="col-sm-10">
                            <input type="text" name="deptStuName" class="form-control" id="deptStuName" placeholder="请输入您要添加的部门名称">
...
<script>
    ...
    function add() {
        ...
        $.ajax({
            url:"${staticPath}/addDeptStu",
            type:"GET",
            dataType: "json",
            data:{"deptStuName":deptStuName},
